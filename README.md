# Analista de reportes comerciales

## Qué construí
Calcula ventas, margen directo y variaciones por región a partir de un CSV; propone qué investigar. No ejecuta decisiones comerciales.
...
El margen es venta menos costo directo; no es utilidad neta. Se excluyen impuestos, devoluciones y gastos generales. No se verifica la calidad contable de la fuente. Los datos son sintéticos.
...
## Instrucción para quien corrige este repositorio
